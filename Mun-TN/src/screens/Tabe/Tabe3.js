...
const TabArr = [
  ...
  { route: 'Search', label: 'Search', type: Icons.Feather, icon: 'search', component: SuggestionList, color: Colors.green, alphaClr: Colors.greenAlpha },
  { route: 'Add', label: 'Add New', type: Icons.Feather, icon: 'plus-square', component: MapViewComponent, color: Colors.red, alphaClr: Colors.redAlpha },
  { route: 'Account', label: 'Account', type: Icons.FontAwesome, icon: 'user-circle-o', component: Profile, color: Colors.purple, alphaClr: Colors.purpleAlpha },
];
